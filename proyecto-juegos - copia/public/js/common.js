...
function selectGameMode(game) {
    ...
    // Contenido del modal
    modal.innerHTML = `
        <div style="background: white; padding: 20px; border-radius: 10px; width: 300px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            <h3 style="margin-bottom: 15px; text-align: center; color: #2c3e50;">Configuración del juego</h3>
            
            <label for="game-mode" style="display: block; margin-bottom: 5px; font-weight: bold;">Modo de juego:</label>
            <select id="game-mode" style="width: 100%; padding: 8px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 4px;">
            ...
            <div id="single-player-form">
                ...
                <input type="text" id="player1-name" placeholder="Ej: Juan" 
                       style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #ddd; border-radius: 4px;" required>
            </div>
